use crate::{
    StaticEnemySkillId, StatusNum, core_actor::CtxContainer, damage::DamageType,
    passive::passive_box::PassiveBox, state::GameState,
};
...
impl EnemySkill {
    pub(crate) fn run_actions(&self, state: &GameState, ctx: &mut CtxContainer) {
        todo!()
    }
