...
// use game_core9::{
//     buttle_char::ButtleChar, buttle_enemy::ButtleEnemy, core_actor::GameCoreActor,
//     lt_common::LtCommon, runtime_id::RuntimeSkillId,
// };
// use iced::{
...
//     border::Radius,
//     widget::{Column, Container, Image, Row, button, column, container, row, scrollable, text},
//     window::icon,
// };
...
//         lt_status_view(enemy.lt(), ctx).into()
//     ]
//     .padding(20)
// }
...
//     let icon_size = 120.0;
//     let image = Image::new(format!("assets/icons/{}.jpg", char.static_id()))
//         .width(Length::Fixed(icon_size))
//         .height(Length::Fixed(icon_size));

//     container(
//         row![column![
//             text(char_name).size(25),
//             row![
//                 image,
//                 column![
//                     text!(
...
//                 .spacing(4),
//             ],
//             lt_status_view(char.lt(), ctx).into()
//         ],]
//         .spacing(10),
//     )
//     .height(Length::Fill)
...
// fn lt_status_view<'a>(lt_common: &LtCommon, _ctx: Ctx<'a>) -> impl Into<Element<'a, Message>> {
//     column![
//         row![
//             column![
//                 row![text!(
...
// fn pause_button() -> Element<'static, Message> {
//     todo!()
// }
